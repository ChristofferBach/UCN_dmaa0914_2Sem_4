...
public class DbConnection {
	...
	//private static final String driver = "jdbc:sqlserver://localhost:1433"; // SQL
	private static final String databaseName = ";databaseName=dmaa0914_2Sem_4";		// SQL Server	
	private static String userName = "; user=dmaa0914_2Sem_4";
